...
* **Polimorfismo:** Implementação de uma lista única (`ArrayList`) que consegue armazenar e manipular diferentes tipos de moedas de forma genérica.
...
1. **Adicionar Moedas:** Inserir valores em **Real**, **Dólar** ou **Euro**.
2. **Remover Moedas:** Retirar valores específicos já existentes no cofrinho.
3. **Listar Moedas:** Exibir todos os itens armazenados.
4. **Calcular Total Convertido:** Somar todos os valores e converter para uma moeda base (**Real**), demonstrando a lógica de conversão individual de cada classe.
